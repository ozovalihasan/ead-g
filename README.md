...
⚠️ An EAD.json file should be generated by using EAD v0.4.7. If your file is v0.4.x, not v0.4.7, you need to upload it to EAD and download it again. So, your file will be updated automatically. Or, you need to downgrade your gem to the version of your file.
